...
export const metadata: Metadata = {
  title: "Contact Us | HRCycle",
  description: "Get in touch with HRCycle for any inquiries or support",
}
          ...
          <div>
            ...
            <div className="mt-3">
              <p className="text-lg text-gray-500">
                Have questions about HRCycle? We're here to help. Fill out the form and we'll get back to you as soon as
                possible.
              </p>
            </div>
            <div className="mt-9">
