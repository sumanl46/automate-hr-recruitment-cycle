...
export const metadata: Metadata = {
  title: "About Us | HRCycle",
  description: "Learn more about HRCycle and our mission to revolutionize HR recruitment",
}
            ...
            <div className="mt-8 lg:mt-0">
              <div className="text-base max-w-prose mx-auto lg:max-w-none">
                <p className="text-lg text-gray-500">
                  Founded in 2023, HRCycle was born from a simple idea: make hiring easier. Our founders, experienced HR
                  professionals, saw firsthand the challenges of traditional recruitment methods. They envisioned a
                  platform that would leverage technology to streamline the entire process.
                </p>
                <div className="mt-5 prose prose-indigo text-gray-500">
                  <p>
                    Today, HRCycle is at the forefront of HR technology, offering innovative solutions that help
