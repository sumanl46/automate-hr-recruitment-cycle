		...
		<div className="max-w-4xl mx-auto w-full py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
			<div className="lg:flex w-full lg:items-center lg:justify-between">
				<div className="flex-1 w-full min-w-0">
					<Link href="/jobs" className="flex items-center text-sm font-semibold text-gray-500">
						<div className="relative flex items-center gap-4">
							<ChevronLeft size={20} />
							<div className="relative">Back</div>
						</div>
					</Link>
					<h2 className="text-3xl font-bold mt-8 text-gray-900 sm:text-4xl sm:truncate">
						Apply for {job.title}
					</h2>
				...
				<form className="mt-4 w-full text-gray-800">
					<div className="relative w-full flex gap-5">
						<div className="relative w-1/2">
							<Label htmlFor="fullName" className="block text-xs font-bold text-gray-500">
								Full name
							</Label>
					...
					<div className="relative mt-5">
						<Label htmlFor="phone" className="block text-xs font-bold text-gray-500">
							Phone Number
						</Label>
						<Input type="tel" placeholder="Phone Number" name="phone" className="mt-2" />
					</div>
					<div className="relative mt-5">
						<Label htmlFor="linkedin" className="block text-xs font-bold text-gray-500">
							LinkedIn Profile(optional)
						</Label>
						<Input type="url" placeholder="LinkedIn URL" name="linkedin" className="mt-2" />
					</div>
					<div className="relative mt-5">
						<Label htmlFor="education" className="block text-xs font-bold mb-2 text-gray-500">
							Education
						</Label>
						<Select>
					...
					<div className="relative mt-5">
						<Label htmlFor="country" className="block text-xs font-bold text-gray-500">
							Country
						</Label>
						<Input type="text" placeholder="Your Country" name="country" className="mt-2" />
					</div>
					<div className="relative mt-5">
						<Label htmlFor="dialog" className="block text-xs font-bold text-gray-500">
							Why are you interested?
						</Label>
						<Textarea placeholder="Express yourself" name="dialog" className="mt-2 min-h-32" />
					</div>
					<div className="relative mt-5">
						<Label htmlFor="resume" className="block text-xs font-bold text-gray-500">
							Resume File
						</Label>
					...
					<div className="relative mt-5">
						<div className="relative flex justify-between">
							<Label htmlFor="coverLetter" className="block text-xs font-bold text-gray-500">
								Cover Letter
							</Label>
