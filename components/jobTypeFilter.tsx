...
const jobTypes = ["Entry-level", "Mid-level", "Senior", "Manager", "Director", "Executive"];
	...
	return (
		<div className="relative group">
			...
			<div
				...
				aria-controls="job-type-dropdown" // Associate button with dropdown
			>
				Job Type
			...
			{isOpen && (
				<div
					ref={dropdownRef}
					id="job-type-dropdown" // Add id for proper association
					className="absolute top-14 left-0 h-auto w-72 z-40 shadow-xl rounded-md border bg-white"
					aria-labelledby="job-type-button" // Link dropdown to button
				>
					<div className="relative flex items-center justify-between border-b px-4 py-2">
						<div className="relative w-1/2 h-full flex items-center">Job Type</div>
